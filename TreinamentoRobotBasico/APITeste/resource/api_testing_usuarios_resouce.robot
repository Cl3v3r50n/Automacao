...
Criar um usuário novo
    ${meu_email}  Generate Random String  length=4  chars=[LETTERS]
    ${meu_email}  Convert To Lower Case   ${meu_email}
    Set Test Variable     ${EMAIL_TESTE}  ${meu_email}@gft.com
    Log  ${EMAIL_TESTE}
...
Conferir os dados retornados
    Log   ${RESP_CONSULTA}
    Dictionary Should Contain Item    ${RESP_CONSULTA}    nome            Cleverson Santos
